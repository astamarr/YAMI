...
public class MainMenuBehaviour : MonoBehaviour {
    ...
    void FixedUpdate()
    {
        if (GO && !Arrived)
        {
           ...
           Voiture.transform.position = Vector3.MoveTowards( Voiture.transform.position, VoitureDestination.transform.position, Time.fixedDeltaTime * 60.0F);
